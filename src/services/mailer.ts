...
class EmailSenderService extends AbstractNotificationService {
  ...
  protected notificationDataService_: NotificationDataService;
  ...
  constructor(container, options) {
    ...
    this.templatePath_ = path.join(__dirname, "../..", "data/templates");
  ...
  async sendNotification(
    ...
    return { to: data.email, status, data: {} };
  }
...
// class MailerService extends NotificationService {
//   static identifier = "mailer";
